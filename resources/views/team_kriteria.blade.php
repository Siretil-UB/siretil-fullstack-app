...
<p class="mt-5 mb-4 text-4xl font-bold font-roboto-slab">TIM ANDA</p>
    ...
    <div class="w-full h-[80%] bg-blue-700 p-10">
        @if ($isKetua==true)
            ...
            <div class="w-full h-full p-4 mt-4 overflow-auto bg-blue-400">
                <div class="flex justify-between">
                    <p class="text-3xl font-normal text-white">Kriteria</p>
                    <div class="flex gap-x-5">
                        <a href="/ketua/team">
                            <button class="px-4 py-2 mb-4 text-xl italic font-bold text-white bg-orange-400 rounded">Lihat Anggota</button>
                        </a>
                    ...
                    <tbody>
                        @foreach ($tim as $a)
                            <tr class="">
                                ...
                                <td class="border border-slate-400">{{$a['fakultas']}}</td>
                                <td class="border border-slate-400">{{$a['jurusan']}}</td>
